    ...
    <div className="relative isolate overflow-hidden bg-[#27115f]">
      ...
      >
        <div class="pr-2 md:mb-14 py-14 md:py-0">
          <h1 class="text-3xl font-semibold text-gray-300 xl:text-5xl lg:text-3xl">
          ...
          {/* <div className="relative isolate justify-left">
            <div className=" ">
              <button className="px-6 py-2 font-medium bg-[#C11574]  text-white w-fit transition-all shadow-[3px_3px_0px_black] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px]">
                Patient
              </button>
              <div className=" ">
                <button className="px-6 py-2 font-medium bg-[#C11574]  text-white w-fit transition-all shadow-[3px_3px_0px_black] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px]">
