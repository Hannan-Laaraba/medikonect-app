...
export default function Appointments() {
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      try {
        const response = await axios.get(`${process.env.REACT_APP_MEDIKONECT_API}/appointments`);
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`${process.env.REACT_APP_MEDIKONECT_API}/appointments/${id}`);
